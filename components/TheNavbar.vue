  ...
  <header class="navbar" :class="{ scrolled: isScrolled, 'menu-open': menuOpen }">
    <div class="container navbar-inner">
      ...
      <nav class="nav-links" :class="{ active: menuOpen }">
        ...
        <NuxtLink to="/projects" class="nav-link" @click="menuOpen = false">Projects</NuxtLink>
        <NuxtLink to="/experience" class="nav-link" @click="menuOpen = false">Experience</NuxtLink>
...
.nav-github:hover { color: var(--primary); transform: scale(1.1); }

  ...
  const projects = [
    {
      ...
      image: '🏗️',
      details: {
        overview: 'Orbit System is a comprehensive engineering company management platform covering the full project lifecycle — from client acquisition through delivery and invoicing. Built with a feature-driven architecture, it provides separate dashboards for admins, project managers, and clients.',
        highlights: [
        ...
        techStack: [
          { category: 'Framework', items: ['Vue 3 (Composition API)', 'TypeScript'] },
          { category: 'State & Routing', items: ['Pinia', 'Vue Router'] },
          { category: 'Styling', items: ['SCSS / SASS', 'Custom design system'] },
    ...
    },
    {
      ...
      image: '📚',
      details: {
        overview: 'A full-featured Learning Management System (LMS) enabling educators to publish courses and students to enroll, watch lectures, and track progress. Integrated an AI chatbot for real-time student support and multiple payment gateways for secure checkout.',
        highlights: [
        ...
        techStack: [
          ...
          { category: 'AI & Payments', items: ['AI Chatbot integration', 'Stripe', 'PayPal'] },
    ...
    },
    {
      ...
      image: '✈️',
      details: {
        overview: 'Alkhalil Traveling is a full-stack travel booking platform handling flights, hotels, and package tours. It generates e-tickets, manages room inventory, and provides a back-office portal for agents and admins to track bookings and revenue.',
        highlights: [
    ...
    },
    {
      ...
      tech: ['Vue 3', 'TypeScript', 'Tailwind CSS 4', 'PrimeVue 4', 'Pinia', 'Axios'],
      features: ['Safety resources', 'Pricing plans', 'Subscription tracking', 'CMS dashboard'],
      color: '#ef4444',
      image: '🛡️',
      details: {
        overview: 'An enterprise Health, Safety & Environment (HSE) management web application built with Vue 3 and Vite. The system provides dedicated modules for managing equipment, observations, hazards, incidents, and safety workflows within an organization — with full multi-language support (English & Arabic/RTL).',
        highlights: [
        ...
        techStack: [
          { category: 'Framework', items: ['Vue 3 (Composition API)', 'Vite', 'TypeScript'] },
          { category: 'UI & Styling', items: ['PrimeVue 4 (Aura theme)', 'Tailwind CSS 4', 'Sass'] },
          { category: 'State & Routing', items: ['Pinia', 'pinia-plugin-persistedstate', 'Vue Router'] },
          { category: 'HTTP & Realtime', items: ['Axios', 'WebSocket (STOMP)'] },
          { category: 'Charts', items: ['Chart.js', 'ApexCharts (vue3-apexcharts)'] },
